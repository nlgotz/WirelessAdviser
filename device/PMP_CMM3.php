...
generalInformationGrouping[ "Status" ][ "gpsAntennaConnectionStatus" ] = "GPS Antenna Connection Status";

generalInformationGrouping[ "Device" ] = new Array();
generalInformationGrouping[ "Device" ][ "macAddress" ] = "MAC Address";

generalInformationGrouping[ "GPS Info" ] = new Array();
generalInformationGrouping[ "GPS Info" ][ "gpsTrackingMode" ] = "Tracking Mode";
generalInformationGrouping[ "GPS Info" ][ "gpsSatellitesTracked" ] = "Satellites Tracked";
generalInformationGrouping[ "GPS Info" ][ "gpsSatellitesVisible" ] = "Satellites Visible";
generalInformationGrouping[ "GPS Info" ][ "gpsLatitude" ] = "Latitude";
generalInformationGrouping[ "GPS Info" ][ "gpsLongitude" ] = "Longitude";
generalInformationGrouping[ "GPS Info" ][ "gpsAltitude" ] = "Altitude";

generalInformationGrouping[ "Port Info" ] = new Array();
generalInformationGrouping[ "Port Info" ][ "port1Description" ] = "Port 1 Description";
generalInformationGrouping[ "Port Info" ][ "port1ManagementStatus" ] = "Port 1 Management Status";
generalInformationGrouping[ "Port Info" ][ "port1PowerStatus" ] = "Port 1 Power Status";
generalInformationGrouping[ "Port Info" ][ "port1UplinkStatus" ] = "Port 1 Uplink Status";
generalInformationGrouping[ "Port Info" ][ "port2Description" ] = "Port 2 Description";
generalInformationGrouping[ "Port Info" ][ "port2ManagementStatus" ] = "Port 2 Management Status";
generalInformationGrouping[ "Port Info" ][ "port2PowerStatus" ] = "Port 2 Power Status";
generalInformationGrouping[ "Port Info" ][ "port2UplinkStatus" ] = "Port 2 Uplink Status";
generalInformationGrouping[ "Port Info" ][ "port3Description" ] = "Port 3 Description";
generalInformationGrouping[ "Port Info" ][ "port3ManagementStatus" ] = "Port 3 Management Status";
generalInformationGrouping[ "Port Info" ][ "port3PowerStatus" ] = "Port 3 Power Status";
generalInformationGrouping[ "Port Info" ][ "port3UplinkStatus" ] = "Port 3 Uplink Status";
generalInformationGrouping[ "Port Info" ][ "port4Description" ] = "Port 4 Description";
generalInformationGrouping[ "Port Info" ][ "port4ManagementStatus" ] = "Port 4 Management Status";
generalInformationGrouping[ "Port Info" ][ "port4PowerStatus" ] = "Port 4 Power Status";
generalInformationGrouping[ "Port Info" ][ "port4UplinkStatus" ] = "Port 4 Uplink Status";
generalInformationGrouping[ "Port Info" ][ "port5Description" ] = "Port 5 Description";
generalInformationGrouping[ "Port Info" ][ "port5ManagementStatus" ] = "Port 5 Management Status";
generalInformationGrouping[ "Port Info" ][ "port5PowerStatus" ] = "Port 5 Power Status";
generalInformationGrouping[ "Port Info" ][ "port5UplinkStatus" ] = "Port 5 Uplink Status";
generalInformationGrouping[ "Port Info" ][ "port6Description" ] = "Port 6 Description";
generalInformationGrouping[ "Port Info" ][ "port6ManagementStatus" ] = "Port 6 Management Status";
generalInformationGrouping[ "Port Info" ][ "port6PowerStatus" ] = "Port 6 Power Status";
generalInformationGrouping[ "Port Info" ][ "port6UplinkStatus" ] = "Port 6 Uplink Status";
generalInformationGrouping[ "Port Info" ][ "port7Description" ] = "Port 7 Description";
generalInformationGrouping[ "Port Info" ][ "port7ManagementStatus" ] = "Port 7 Management Status";
generalInformationGrouping[ "Port Info" ][ "port7PowerStatus" ] = "Port 7 Power Status";
generalInformationGrouping[ "Port Info" ][ "port7UplinkStatus" ] = "Port 7 Uplink Status";
generalInformationGrouping[ "Port Info" ][ "port8Description" ] = "Port 8 Description";
generalInformationGrouping[ "Port Info" ][ "port8ManagementStatus" ] = "Port 8 Management Status";
generalInformationGrouping[ "Port Info" ][ "port8PowerStatus" ] = "Port 8 Power Status";
generalInformationGrouping[ "Port Info" ][ "port8UplinkStatus" ] = "Port 8 Uplink Status";
