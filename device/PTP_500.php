...
generalInformationGrouping[ "Status" ][ "dataPortStatus" ] = "Data Port Status";
generalInformationGrouping[ "Status" ][ "ethernetStatus" ] = "Ethernet Link Status";
generalInformationGrouping[ "Status" ][ "rfStatus" ] = "RF Link Status";

generalInformationGrouping[ "Device" ] = new Array();
generalInformationGrouping[ "Device" ][ "macAddress" ] = "MAC Address";
generalInformationGrouping[ "Device" ][ "deviceRegionCode" ] = "Region Code";
generalInformationGrouping[ "Device" ][ "gatewayAddress" ] = "Gateway Address";
generalInformationGrouping[ "Device" ][ "subnetMask" ] = "Subnet Mask";

generalInformationGrouping[ "Radio" ] = new Array();
generalInformationGrouping[ "Radio" ][ "deviceAsymmectricTdd" ] = "Device Asym Tdd";

generalInformationGrouping[ "Link" ] = new Array();
generalInformationGrouping[ "Link" ][ "registeredTo" ] = "Registered To";
generalInformationGrouping[ "Link" ][ "linkName" ] = "Link Name";
...
probeDataGrouping[ "rfLinkAvailability" ] = "RF Link Availability";
probeDataGrouping[ "rfVectorError" ] = "RF Vector Error";
probeDataGrouping[ "rfLinkLoss" ] = "RF Link Loss";
probeDataGrouping[ "linkCapacity" ] = "Link Capacity";
probeDataGrouping[ "txModulationMode" ] = "Tx Modulation Mode";
probeDataGrouping[ "rxModulationMode" ] = "Rx Modulation Mode";
probeDataGrouping[ "rfReceiveModulationModeDetails" ] = "RF Receive Modulation Mode Details";
probeDataGrouping[ "rfDistance" ] = "RF Distance";
probeDataGrouping[ "signalStrengthRatio" ] = "Signal Strength Ratio";
probeDataGrouping[ "rxFrequency" ] = "Rx Frequency";
probeDataGrouping[ "txFrequency" ] = "Tx Frequency";
probeDataGrouping[ "ethernetLinkSpeed" ] = "Ethernet Link Speed";
probeDataGrouping[ "rfTransmitDataRate" ] = "RF Transmit Data Rate";
probeDataGrouping[ "rfReceiveDataRate" ] = "RF Receive Data Rate";
probeDataGrouping[ "rfReceivePower" ] = "RF Receive Power";
probeDataGrouping[ "rfTransmitPower" ] = "RF Transmit Power";
