...
generalInformationGrouping[ "Basic Info" ][ "sysUpTime" ] = "Up Time";
generalInformationGrouping[ "Basic Info" ][ "SoftwareVersion" ] = "Software Version";

generalInformationGrouping[ "IP Info" ] = new Array();
generalInformationGrouping[ "IP Info" ][ "RFIP" ] = "RF IP Address";
generalInformationGrouping[ "IP Info" ][ "RFMask" ] = "RF Mask";
generalInformationGrouping[ "IP Info" ][ "RFGateway" ] = "RF Gateway";
generalInformationGrouping[ "IP Info" ][ "LANIP" ] = "LAN IP Address";
...
function refreshHeaderInfo()
{
	...
	{	
		...
		headerText += '<br><span style="font-size:x-small;"><b>Device ID: </b>' + headerInfo.device_id;
		headerText += ', <b>Device IP: </b><a href="http://' + headerInfo.ip_address + '">' + headerInfo.ip_address + '</a>';
		headerText += '<b>, Device Type: </b>' + headerInfo.device_type + '</i></span></td></tr>';
		headerText += '</table>';
