...
generalInformationGrouping[ "Device" ][ "sysSer" ] = "Device Serial Number";
generalInformationGrouping[ "Device" ][ "macAddress" ] = "MAC Address";
generalInformationGrouping[ "Device" ][ "HWVersion" ] = "HW Version";
generalInformationGrouping[ "Device" ][ "BootVersion" ] = "Boot Version";
generalInformationGrouping[ "Device" ][ "RFVersion" ] = "RF Version";
generalInformationGrouping[ "Device" ][ "Azimuth" ] = "Azimuth";
generalInformationGrouping[ "Device" ][ "Inclination" ] = "Inclination";

generalInformationGrouping[ "Status" ] = new Array();
generalInformationGrouping[ "Status" ][ "sysUpTime" ] = "Up Time";
generalInformationGrouping[ "Status" ][ "sysFreq" ] = "Current Frequency [kHz]";

generalInformationGrouping[ "Radio" ] = new Array();
generalInformationGrouping[ "Radio" ][ "ConfiguredBSID" ] = "BSID";
generalInformationGrouping[ "Radio" ][ "ConfiguredAuthentitcationMode" ] = "Configured Auth Mode";

generalInformationGrouping[ "GPS" ] = new Array();
generalInformationGrouping[ "GPS" ][ "GPSYPosition" ] = "Latitude";
generalInformationGrouping[ "GPS" ][ "GPSXPosition" ] = "Longitude";
generalInformationGrouping[ "GPS" ][ "GPSZPosition" ] = "";
...
function refreshHeaderInfo()
{
	...
	{	
		...
		headerText += '<br><span style="font-size:x-small;"><b>Device ID: </b>' + headerInfo.device_id + ', <b>Device IP: </b><a href="https://' + headerInfo.ip_address + '">' + headerInfo.ip_address + '</a><b>, Device Type: </b>' + headerInfo.device_type + '</i></span></td></tr>';
		headerText += '</table>';
