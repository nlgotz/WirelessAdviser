...
generalInformationGrouping[ "Status" ][ "deviceStatus" ] = "Device Status";
...
generalInformationGrouping[ "Device" ][ "networkOperatingMode" ] = "Network Operating Mode";

generalInformationGrouping[ "Radio" ] = new Array();
generalInformationGrouping[ "Radio" ][ "bsid" ] = "Base Station MAC Address (BSID)";
generalInformationGrouping[ "Radio" ][ "rssiReport" ] = "RSSI";
generalInformationGrouping[ "Radio" ][ "cinrReport" ] = "CINR";
generalInformationGrouping[ "Radio" ][ "txPower" ] = "Transmit Power (dBm)";
generalInformationGrouping[ "Radio" ][ "centerFrequency" ] = "Linked Frequency (KHz)";
generalInformationGrouping[ "Radio" ][ "deviceBandwidth" ] = "Device Bandwidth (KHz)";
generalInformationGrouping[ "Radio" ][ "uplinkDataRate" ] = "Uplink Data Rate (Kbps)";
generalInformationGrouping[ "Radio" ][ "downlinkDataRate" ] = "Down Link Data Rate (Kbps)";
generalInformationGrouping[ "Radio" ][ "uplinkModulationType" ] = "Up Link Modulation Type";
generalInformationGrouping[ "Radio" ][ "downlinkModulationType" ] = "Down Link Modulation Type";
